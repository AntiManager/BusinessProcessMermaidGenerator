...
3. Выберите файл и лист с данными и папку для сохранения отчетов, или воспользуйтесь шаблоном из примера (Создать пример БП-файла)

4. Настройте параметры:

- Параметры анализа: Бизнес-процессы или Causal Loop Diagrams (Диаграммы причинно-следственных связей)

- Формат вывода (рекомендуем HTML +интерактивная - панорамирование и масштабирование для бизнес-процессов; интерактивная для CLD диаграмм)

- Группировку операций (Группа - пользовательская группировка, Владелец - группировка типа дорожек в BPMN) работает только при построении бизнес-процессов

- Дополнительные настройки (для бизнес процессов - Подробное описание, размещает в узлах подробное описание процесса; для CLD - отражение на стрелках связи знака влияния и/или операции связи)

5. Сгенерируйте диаграмму - результат автоматически откроется в браузере

6. Экспортируйте отчет в Excel для структурирования данных и переиспользования в дальнейшем
