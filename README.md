...
[BP_diagram](BusinessProcessMermaidGenerator/BP_diagram.md)
...
**Пример вывода отчета:**
[CLD_diagram](BusinessProcessMermaidGenerator/CLD_diagram.md)
...
- 📄 Mermaid Markdown - для документации и Git, образец: [BP_diagram](BusinessProcessMermaidGenerator/BP_diagram.md)

- 🌐 HTML + Mermaid - интерактивное просмотр, образец: [BP_diagram.html](BusinessProcessMermaidGenerator/BP_diagram.html)

- 🎮 Интерактивный граф - исследование связей


#### Для системной динамики:
- 🔄 CLD Mermaid - документация причинно-следственных связей, образец: [CLD_diagram](BusinessProcessMermaidGenerator/CLD_diagram.md)

- 🌐 Интерактивный CLD - анализ сложных систем, образец: [CLD_diagram_vis.html](BusinessProcessMermaidGenerator/CLD_diagram_vis.html)
