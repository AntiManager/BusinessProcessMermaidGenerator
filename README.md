...
- 📄 Mermaid Markdown - для документации и Git, образец: [[BP_diagram]]

- 🌐 HTML + Mermaid - интерактивное просмотр, образец: [[BP_diagram.html]]

- 🎮 Интерактивный граф - исследование связей


#### Для системной динамики:
- 🔄 CLD Mermaid - документация причинно-следственных связей, образец: [[CLD_diagram]]

- 🌐 Интерактивный CLD - анализ сложных систем, образец: [[CLD_diagram_vis.html]]
...
https://github.com/AntiManager/BusinessProcessMermaidGenerator/releases/download/Latest/BusinessProcessGenerator.exe
...
Подробнее о структуре программы в [[about.txt]]
