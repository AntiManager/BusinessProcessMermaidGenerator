...
- 📄 Mermaid Markdown - для документации и Git

- 🌐 HTML + Mermaid - интерактивное просмотр

- 🎮 Интерактивный граф - исследование связей

- 🖼️ SVG с навигацией - профессиональная работа (рекомендуем)

#### Для системной динамики:
- 🔄 CLD Mermaid - документация причинно-следственных связей

- 🌐 Интерактивный CLD - анализ сложных систем
...
- 📊 Расширенная аналитика: расчет сложности процесса, трудоемкости, стоимости; определение категорий входо/выходов (материальный, информационный, финансовый)
